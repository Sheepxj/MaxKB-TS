...
import Auth from '@/views/chat_south/auth/index.vue'
...
const components: any = import.meta.glob('@/views/chat_south/**/index.vue', {
  eager: true
})
...
const currentTemplate = computed(() => {
  ...
  const name = `/src/views/chat_south/${modeName}/index.vue`
