<template>
  ...
  <component
    :is="auth_components[`/src/views/chat_south/auth/component/${auth_type}.vue`].default"
    v-model="is_auth"
...
const auth_components: any = import.meta.glob('@/views/chat_south/auth/component/*.vue', {
  eager: true
})
